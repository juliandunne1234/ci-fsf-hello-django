...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-o!2!bugnx2jikvtjgxhtkqx!i(g8n!pn80eu%m&du1)j)ov8l$')
...
# ALLOWED_HOSTS = ['localhost', 'ckz8780-django-todo-app-lesson.herokuapp.com']
# # Application definition
